...
const DashboardMap = dynamic(() => import('../heatmap/HeatmapMap'), { ssr: false })
    ...
    <div>
      <div style={{ marginBottom:'24px' }}>
        <div style={{ display:'flex', alignItems:'center', gap:'8px', marginBottom:'8px' }}>
          <div style={{ width:'6px', height:'6px', borderRadius:'50%', background:'#ff4d6d', boxShadow:'0 0 8px #ff4d6d' }} />
        ...
        <p style={{ fontSize:'13px', color:'#5a6370' }}>Real-time crowd-sourced counterfeit medicine detection across Pakistan</p>
      </div>
      ...
      {/* Map Container */}
      <div style={{ borderRadius:'20px', overflow:'hidden', border:'1px solid rgba(255,255,255,0.08)', height:'480px', position:'relative', background:'#0d0e13' }}>
        {loading ? (
          <div style={{ height:'100%', display:'flex', alignItems:'center', justifyContent:'center' }}>
            <div style={{ textAlign:'center' }}>
              ...
              <p style={{ color:'#ff4d6d', fontFamily:'Space Grotesk, sans-serif' }}>Loading threat intelligence...</p>
            </div>
          </div>
        ) : (
          <DashboardMap points={filteredPoints} />
        )}
      </div>
